...
RSpec.describe NewsApi do
  ...
  describe '#validate' do
    it 'invalid parameter sequence (sources mixed with country)' do
    ...
    it 'invalid parameter sequence' do
      args = { q: 'Some query', sources: 'sports', country: 'mx' }
      news = NewsApi::Query.new(api_key)
  ...
  describe '#response' do
    ...
    it 'responds successfully a json (sources) when no format is sent' do
      args = {}
      news = NewsApi::Query.new(api_key)
